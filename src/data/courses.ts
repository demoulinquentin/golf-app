...
export const PRELOADED_COURSES: PreloadedCourse[] = [
  ...
  },
  {
    ...
    holes: [
      ...
      { hole: 4, par: 3, strokeIndex: 12 },
      { hole: 5, par: 4, strokeIndex: 5 },
      { hole: 6, par: 3, strokeIndex: 16 },
      { hole: 7, par: 4, strokeIndex: 9 },
      { hole: 8, par: 4, strokeIndex: 7 },
      { hole: 9, par: 4, strokeIndex: 3 },
      { hole: 10, par: 5, strokeIndex: 10 },
      { hole: 11, par: 4, strokeIndex: 13 },
      { hole: 12, par: 4, strokeIndex: 6 },
      { hole: 13, par: 3, strokeIndex: 18 },
      { hole: 14, par: 5, strokeIndex: 15 },
      { hole: 15, par: 3, strokeIndex: 17 },
      { hole: 16, par: 4, strokeIndex: 11 },
      { hole: 17, par: 4, strokeIndex: 2 },
      { hole: 18, par: 5, strokeIndex: 8 },
    ],
  },
  {
    id: "amiraute-arts",
